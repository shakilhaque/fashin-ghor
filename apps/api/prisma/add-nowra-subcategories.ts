...
const PARENT_CATEGORY = 'Nowra';
const SUBCATEGORIES = ['Kids Wear', 'Combos', 'Goj Kapor'];

async function main() {
  console.warn('🧭 Adding Nowra subcategories...');
  ...
  console.warn('🎉 Nowra subcategories complete!');
}
