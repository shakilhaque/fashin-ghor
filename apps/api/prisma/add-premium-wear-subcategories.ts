...
const PARENT_CATEGORY = 'Premium Wear';
const SUBCATEGORIES = ['Pakistani'];

async function main() {
  console.warn('🧭 Adding Premium Wear subcategories...');
  ...
  console.warn('🎉 Premium Wear subcategories complete!');
}
